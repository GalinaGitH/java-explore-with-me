...
public class RequestServiceImpl implements RequestService {
    ...
    public ParticipationRequestDto confirmParticipationRequest(long userId, long eventId, long requestId) {
        ...
        if (!event.getInitiator().equals(user)) {
            throw new NonComplianceWithTheRulesOfParticipationException("Initiator can confirm applications " +
        ...
        if (limit != 0 && numberOfApplications == limit) {
            throw new NonComplianceWithTheRulesOfParticipationException("limit of applications for participation" +
                    " is exhausted");
        }
    ...
    public ParticipationRequestDto addRequest(long userId, long eventId) {
        ...
        if (event.getInitiator().equals(user)) {
            throw new NonComplianceWithTheRulesOfParticipationException("initiator doesn't need to apply" +
                    " for participation");
        }
        ...
        if (event.getParticipantLimit() != 0 && event.getParticipantLimit() == event.getConfirmedRequests()) {
            throw new NonComplianceWithTheRulesOfParticipationException("limit of applications " +
